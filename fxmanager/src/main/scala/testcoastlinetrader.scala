...
object TestingCoastlineTrader {
	...
	//	CoastlineTrader2(override val exposure: Int, lastTick: Tick, active: Boolean,
	//override val avgPrice: Double, override val realizedAvgPrice: Double, override val totalRealizedProfit: Double,
	//scale: Double, tick0: Tick, p0: Int	
		val trader = Agent( CoastlineTrader2(10000, 
											 Tick(price0.get.time, price0.get.bid, price0.get.ask),
											 true,
											 price0.get.ask,
											 price0.get.ask,
											 0.0,
